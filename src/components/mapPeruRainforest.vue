...
import am5geodata_peruRainforestLow from "@amcharts/amcharts5-geodata/peruRainforestLow";
...
export default {
  ...
  data(){
    return {
      objStatesData: {
        AMA: {color: am5.color("#252351"), lat: -1.602249, lon: -82.911071, noPrazo: 1, total: 2, atrasada: 3},
        LOR: {color: am5.color("#252351"), lat: -3.602249, lon: -82.911071, noPrazo: 1, total: 2, atrasada: 3},
        MDD: {color: am5.color("#252351"), lat: -5.602249, lon: -82.911071, noPrazo: 10, total: 20, atrasada: 30},
        SAM: {color: am5.color("#252351"), lat: -1.602249, lon: -68.411071, noPrazo: 4, total: 5, atrasada: 6},
        UCA: {color: am5.color("#252351"), lat: -3.602249, lon: -68.411071, noPrazo: 1, total: 2, atrasada: 3},
      },
      auxIdx: -1,
    }
  },
  mounted() {
    ...
    let peruSeries = chart.series.push(
      am5map.MapPolygonSeries.new(root, {
        geoJSON: am5geodata_peruRainforestLow
      })
    );
