...
import am5geodata_chileAustralLow from "@amcharts/amcharts5-geodata/chileAustralLow";
...
export default {
  ...
  data(){
    return {
      objStatesData: {
        AI: {color: am5.color("#5D686E"), lat: -45.620327, lon: -83.149890, noPrazo: 1, total: 2, atrasada: 3},
        MA: {color: am5.color("#5D686E"), lat: -45.620327, lon: -66.149890, noPrazo: 1, total: 2, atrasada: 3},
      },
      auxIdx: -1,
    }
  },
  mounted() {
    ...
    let chileSeries = chart.series.push(
      am5map.MapPolygonSeries.new(root, {
        geoJSON: am5geodata_chileAustralLow
      })
    );
