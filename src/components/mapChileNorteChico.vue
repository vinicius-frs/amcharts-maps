...
import am5geodata_chileNorteChicoLow from "@amcharts/amcharts5-geodata/chileNorteChicoLow";
...
export default {
  ...
  data(){
    return {
      objStatesData: {
        AT: {color: am5.color("#FECA19"), lat: -26.620327, lon: -74.149890, noPrazo: 1, total: 2, atrasada: 3},
        CO: {color: am5.color("#FECA19"), lat: -26.620327, lon: -67.149890, noPrazo: 1, total: 2, atrasada: 3},
      },
      auxIdx: -1,
    }
  },
  mounted() {
    ...
    let chileSeries = chart.series.push(
      am5map.MapPolygonSeries.new(root, {
        geoJSON: am5geodata_chileNorteChicoLow
      })
    );
