...
import am5geodata_chileSurLow from "@amcharts/amcharts5-geodata/chileSurLow";
...
export default {
  ...
  data(){
    return {
      objStatesData: {
        AR: {color: am5.color("#009757"), lat: -38.220327, lon: -77.149890, noPrazo: 1, total: 2, atrasada: 3},
        LL: {color: am5.color("#009757"), lat: -40.220327, lon: -77.149890, noPrazo: 1, total: 2, atrasada: 3},
        LR: {color: am5.color("#009757"), lat: -38.220327, lon: -69.149890, noPrazo: 1, total: 2, atrasada: 3},
      },
      auxIdx: -1,
    }
  },
  mounted() {
    ...
    let chileSeries = chart.series.push(
      am5map.MapPolygonSeries.new(root, {
        geoJSON: am5geodata_chileSurLow
      })
    );
