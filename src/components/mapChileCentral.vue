...
import am5geodata_chileCentralLow from "@amcharts/amcharts5-geodata/chileCentralLow";
...
export default {
  ...
  data(){
    return {
      objStatesData: {
        BI: {color: am5.color("#E8385F"), lat: -30.120327, lon: -81.149890, noPrazo: 1, total: 2, atrasada: 3},
        LI: {color: am5.color("#E8385F"), lat: -34.120327, lon: -81.149890, noPrazo: 1, total: 2, atrasada: 3},
        ML: {color: am5.color("#E8385F"), lat: -38.120327, lon: -81.149890, noPrazo: 1, total: 2, atrasada: 3},
        NB: {color: am5.color("#E8385F"), lat: -30.120327, lon: -66.149890, noPrazo: 1, total: 2, atrasada: 3},
        RM: {color: am5.color("#E8385F"), lat: -34.120327, lon: -66.149890, noPrazo: 1, total: 2, atrasada: 3},
        VS: {color: am5.color("#E8385F"), lat: -38.120327, lon: -66.149890, noPrazo: 1, total: 2, atrasada: 3},
      },
      auxIdx: -1,
    }
  },
  mounted() {
    ...
    let chart = root.container.children.push(
      am5map.MapChart.new(root, {
        minZoomLevel: 0.9,
        homeZoomLevel: 0.9,
        homeGeoPoint: { longitude: -71.046485, latitude: -36.270327 },
      })
    );

    let chileSeries = chart.series.push(
      am5map.MapPolygonSeries.new(root, {
        geoJSON: am5geodata_chileCentralLow
      })
    );
